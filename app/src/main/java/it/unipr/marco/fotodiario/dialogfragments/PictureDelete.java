...
public class PictureDelete extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState){
        ...
        builder.setMessage(R.string.pictureDeleteQuestion);
        builder.setPositiveButton("Si", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                //Funzione magica per passare una string all'Activity chiamante
                mCallback.onSelectedData(Vars.FRAGMENT_PICTURE_DELETE);
            }
        });
